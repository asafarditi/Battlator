...
export const useMapStore = create<MapState>((set) => ({
  // Initial state
  currentPosition: { latitude: 33.2778, longitude: 35.5928 }, // Default to Northern Israel
  ...
  addThreatZone: (coordinates, level) => set((state) => ({ 
    threatZones: [...state.threatZones, { 
      id: generateId(),
      coordinates,
      level
    }]
